...
(function() {
  ...
  // Import the deleteModal.js script for modal functionality
  import('/static/js/components/deleteModal.js').catch(error => {
    log('error', 'main.js', 'moduleLoad', `Failed to load delete modal module: ${error.message}`);
  });
