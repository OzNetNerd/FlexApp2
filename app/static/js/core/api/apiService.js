/**
 * core/api/apiService.js
 * API service for fetching and normalizing data
 */

import log from '/static/js/core/utils/logger.js';
import { getDatasetVariables, getDatasetValue, fetchApiData } from '/static/src/core/utils/utils.js';
