...
#
#         if errors:
#             table_context = TableContext(title="Create Opportunity", errors=errors, form_data=form_data)
...
#
#     table_context = TableContext(title="Create Opportunity")
#     return render_safely("pages/crud/create.html", table_context, "Failed to load create opportunity form.")
