...
def index():
    """Companies list page."""
    context = SimpleContext(title="Companies", entity_name="Companies")
...
def create():
    """Create company form."""
    context = SimpleContext(title="Create Company")
...
def view(item_id):
    ...
    context = SimpleContext(title="View Company")
...
def edit(item_id):
    """Edit company form."""
    context = SimpleContext(title="Edit Company")
