...
from app.routes.web.crud.components.create import create_route
from app.routes.web.crud.components.edit import edit_route
from app.routes.web.crud.components.view import view_route
from app.routes.web.crud.components.delete import delete_route
from app.routes.web.crud.components.data import data_route
from app.routes.web.crud.components.index import index_route
