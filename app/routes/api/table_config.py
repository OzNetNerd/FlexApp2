...
def get_config(table_name):
    """
    Get the table configuration for the given table.
...
def save_config(table_name):
    """
    Save the table configuration for the given table.
...
def reset_config(table_name):
    """
    Reset the table configuration to the default layout.

    Args:
        table_name (str): The table name to reset.
    ...
    default_configs = {
        ...
        "opportunities": [
            ...
            {"field": "name", "headerName": "Name", "hide": False, "width": 200},
            {"field": "description", "headerName": "Description", "hide": False, "width": 300},
            {"field": "opportunityStage", "headerName": "Stage", "hide": False, "width": 120},
            {"field": "value", "headerName": "Value", "hide": False, "width": 120, "valueFormatter": "money", "comparator": "number", "filter": "agNumberColumnFilter"},
