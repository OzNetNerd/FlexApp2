...
def register_crud_routes(blueprint, entity_name, template_dir="pages/crud", table_template="pages/tables"):
    ...
    def index():
        ...
        context = SimpleContext(title=plural_name.capitalize(), read_only=True)
    ...
    def create():
        ...
        context = SimpleContext(title=f"Create {entity_title}")
    ...
    def view(item_id):
        ...
        context = SimpleContext(title=f"View {entity_title}", item_id=item_id)
    ...
    def edit(item_id):
        ...
        context = SimpleContext(title=f"Edit {entity_title}", item_id=item_id)
