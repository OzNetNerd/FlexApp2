"""JSON serialization utilities for data validation and conversion.

This module provides utilities to validate and ensure that data structures
are JSON serializable, particularly important for API and persistence operations.
"""
...
class JSONValidator:
    ...
    This utility class provides methods to check if data structures can be
    serialized to JSON and converts complex objects to serializable formats.
    """
    ...
    def validate_json_serializable(self, data: Dict[str, Any], path: str = "") -> List[str]:
        ...
        Returns:
            List of paths where serialization errors were found.
        """
        issues = []
    ...
    def ensure_json_serializable(self, data: Any) -> Any:
